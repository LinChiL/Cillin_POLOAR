...
def poloar_diagnostic_cifar(mu, log_var, loss, energy_const=5e4): 
...
# --- 核心实验函数 ---
def run_experiment(lambda_val, all_x, all_y, test_x, test_y, epochs=25):
    device = all_x.device
