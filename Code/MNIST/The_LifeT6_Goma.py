...
def poloar_diagnostic(mu, log_var, loss, energy_const=3000): # 微调基准能效（给系统更大的杠杆压力）
...
# --- 终极采样方案：锁定 3.1e-6 的最终跨越 ---
# 这一次，我们略微增加 λ，并调低能量基准，直接击穿 L=1 的屏障 
lambdas = [3.1e-6, 3.2e-6, 3.3e-6, 3.4e-6] 
results = {"λ": [], "acc": [], "rob": [], "L": []}
